                ...
                <footer className="py-4 bgfooter ">
                    <div className="row mx-4">
                        <div className="sectionFooter offset-1 col-md-2 col-sm-12 mb-2">
                            ...
                            <ul className="nav flex-column">
                                <li className="nav-item mb-2 "><Link to={"/"} className="nav-link p-0 text-dark all_link    text-white">Ecole VBC</Link></li>
                                <li className="nav-item mb-2 "><Link to={"/"} className="nav-link p-0 text-dark all_link    text-white">Ecole VBC</Link></li>
                                <li className="nav-item mb-2 "><Link to={"/"} className="nav-link p-0 text-dark all_link    text-white">Ecole VBC</Link></li>
                                <li className="nav-item mb-2 "><Link to={"/"} className="nav-link p-0 text-dark all_link    text-white">Ecole VBC</Link></li>
                            </ul>
                        ...
                        <div className="col-md-3 col-sm-12 offset-1 mb-2 sectionFooter">
                            ...
                            <ul className="nav flex-column">
                                <li className="nav-item mb-2 text-white"><Link to={'/'} className="nav-link p-0 text-dark all_link    text-white">Ecole VBC</Link></li>
                                <li className="nav-item mb-2 text-white"><Link to={"/"} className="nav-link p-0 text-dark all_link    text-white">Ecole VBC</Link></li>
                                <li className="nav-item mb-2 text-white"><Link to={"/"} className="nav-link p-0 text-dark all_link    text-white">Ecole VBC</Link></li>
                                <li className="nav-item mb-2 text-white"><Link to={"/"} className="nav-link p-0 text-dark all_link    text-white">Ecole VBC</Link></li>
                            </ul>
                    ...
                    <div className="border-top text-center">
                        <p className={'designed text-white mt-5'} >
                            &copy; {new Date().getFullYear()} VBC All rights reserved.designed and developped by EB-COMPANY
                        </p>
